...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_direction );
      signalAccess[1] = new CDataSignalAccess( top.io_step );
      signalAccess[2] = new CDataSignalAccess( top.io_start );
      signalAccess[3] = new CDataSignalAccess( top.io_stop );
      signalAccess[4] = new CDataSignalAccess( top.io_init );
      signalAccess[5] = new SDataSignalAccess( top.io_output );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\SawToothWaveGenerator/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\SawToothWaveGenerator/") + name + ".dat").c_str());
      #endif
    }
