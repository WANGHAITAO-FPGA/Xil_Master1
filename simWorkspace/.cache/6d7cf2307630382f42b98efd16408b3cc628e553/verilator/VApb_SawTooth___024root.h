...
VL_MODULE(VApb_SawTooth___024root) {
  public:
    ...
    struct {
        ...
        CData/*4:0*/ Apb_SawTooth__DOT__ad5544_1__DOT__sawtooth_1__DOT__counter_valueNext;
        CData/*4:0*/ Apb_SawTooth__DOT__ad5544_1__DOT__sawtooth_1__DOT__counter_value;
