...
VL_MODULE(VSawToothWaveGenerator___024root) {
  public:
    ...
    CData/*0:0*/ SawToothWaveGenerator__DOT__tick;
    ...
    CData/*0:0*/ SawToothWaveGenerator__DOT__tick_regNext;
    CData/*0:0*/ SawToothWaveGenerator__DOT__when_SawToothWaveGenerator_l52;
    CData/*0:0*/ SawToothWaveGenerator__DOT__when_SawToothWaveGenerator_l58;
