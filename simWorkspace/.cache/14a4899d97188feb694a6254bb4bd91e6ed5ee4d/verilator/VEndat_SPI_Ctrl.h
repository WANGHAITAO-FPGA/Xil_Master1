...
VL_MODULE(VEndat_SPI_Ctrl) {
  public:
    ...
    CData/*0:0*/ Endat_SPI_Ctrl__DOT__enable;
    CData/*0:0*/ Endat_SPI_Ctrl__DOT__fsm_wantStart;
    CData/*1:0*/ Endat_SPI_Ctrl__DOT__fsm_stateReg;
    CData/*1:0*/ Endat_SPI_Ctrl__DOT__fsm_stateNext;
    ...
    static WData/*95:0*/ __Vtable1_Endat_SPI_Ctrl__DOT__fsm_stateReg_string[4][3];
    static WData/*95:0*/ __Vtable2_Endat_SPI_Ctrl__DOT__fsm_stateNext_string[4][3];
    static CData/*1:0*/ __Vtable3_Endat_SPI_Ctrl__DOT__fsm_stateNext[32];
