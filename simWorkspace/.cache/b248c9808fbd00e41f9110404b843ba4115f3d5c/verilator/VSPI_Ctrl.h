...
VL_MODULE(VSPI_Ctrl) {
  public:
    ...
    static CData/*0:0*/ __Vtable3_SPI_Ctrl__DOT__timer_reset[256];
    static CData/*0:0*/ __Vtable4_SPI_Ctrl__DOT__fsm_wantStart[8];
    static CData/*0:0*/ __Vtable5_SPI_Ctrl__DOT__fsm_counter_willIncrement[16];
