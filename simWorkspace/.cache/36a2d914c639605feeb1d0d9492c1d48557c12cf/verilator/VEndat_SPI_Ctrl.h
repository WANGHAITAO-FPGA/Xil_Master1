...
VL_MODULE(VEndat_SPI_Ctrl) {
  public:
    ...
    CData/*2:0*/ __Vdly__Endat_SPI_Ctrl__DOT__fsm_stateReg;
    CData/*5:0*/ __Vdlyvdim0__Endat_SPI_Ctrl__DOT__wr_fifo__DOT__logic_ram__v0;
    CData/*0:0*/ __Vdlyvset__Endat_SPI_Ctrl__DOT__wr_fifo__DOT__logic_ram__v0;
    CData/*0:0*/ __Vclklast__TOP__clk;
    CData/*0:0*/ __Vclklast__TOP__reset;
    SData/*15:0*/ __Vdlyvval__Endat_SPI_Ctrl__DOT__wr_fifo__DOT__logic_ram__v0;
    IData/*31:0*/ __Vm_traceActivity;
    CData/*1:0*/ __Vtablechg5[128];
    ...
    static CData/*0:0*/ __Vtable5_Endat_SPI_Ctrl__DOT__valid[128];
    static CData/*2:0*/ __Vtable5_Endat_SPI_Ctrl__DOT__fsm_stateReg[128];
    static CData/*0:0*/ __Vtable6_Endat_SPI_Ctrl__DOT__mode[16];
  ...
  public:
    static void _combo__TOP__4(VEndat_SPI_Ctrl__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__6(VEndat_SPI_Ctrl__Syms* __restrict vlSymsp);
    ...
    static void traceChgThis__11(VEndat_SPI_Ctrl__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    static void traceChgThis__12(VEndat_SPI_Ctrl__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
