...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new SDataSignalAccess( top.c_data );
      signalAccess[1] = new SDataSignalAccess( top.d1_data );
      signalAccess[2] = new SDataSignalAccess( top.d2_data );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\FullStep/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\FullStep/") + name + ".dat").c_str());
      #endif
    }
