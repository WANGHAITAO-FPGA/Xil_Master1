...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.spi_sclk );
      signalAccess[1] = new CDataSignalAccess( top.spi_mosi );
      signalAccess[2] = new CDataSignalAccess( top.spi_ss );
      signalAccess[3] = new CDataSignalAccess( top.spi_miso );
      signalAccess[4] = new CDataSignalAccess( top.cmddata_valid );
      signalAccess[5] = new SDataSignalAccess( top.cmddata_payload_Identity_Addr );
      signalAccess[6] = new SDataSignalAccess( top.cmddata_payload_CmdData_0 );
      signalAccess[7] = new SDataSignalAccess( top.cmddata_payload_CmdData_1 );
      signalAccess[8] = new SDataSignalAccess( top.cmddata_payload_CmdData_2 );
      signalAccess[9] = new SDataSignalAccess( top.cmddata_payload_CmdData_3 );
      signalAccess[10] = new CDataSignalAccess( top.cmddata_payload_Bytenumber );
      signalAccess[11] = new CDataSignalAccess( top.rspdata_valid );
      signalAccess[12] = new SDataSignalAccess( top.rspdata_payload_RspData_0 );
      signalAccess[13] = new SDataSignalAccess( top.rspdata_payload_RspData_1 );
      signalAccess[14] = new SDataSignalAccess( top.rspdata_payload_RspData_2 );
      signalAccess[15] = new SDataSignalAccess( top.rspdata_payload_RspData_3 );
      signalAccess[16] = new SDataSignalAccess( top.rspdata_payload_RspData_4 );
      signalAccess[17] = new CDataSignalAccess( top.clk );
      signalAccess[18] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\Endat_SPI_Ctrl/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\Endat_SPI_Ctrl/") + name + ".dat").c_str());
      #endif
    }
