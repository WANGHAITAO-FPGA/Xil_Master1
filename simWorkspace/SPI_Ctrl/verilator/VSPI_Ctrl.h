...
VL_MODULE(VSPI_Ctrl) {
  public:
    ...
    CData/*0:0*/ SPI_Ctrl__DOT__fsm_rsp_valid;
    ...
    CData/*0:0*/ SPI_Ctrl__DOT__rd_fifo__DOT___zz_1;
    CData/*0:0*/ SPI_Ctrl__DOT__rd_fifo__DOT__logic_pushPtr_willIncrement;
    ...
    CData/*5:0*/ __Vdlyvdim0__SPI_Ctrl__DOT__wr_fifo__DOT__logic_ram__v0;
    CData/*0:0*/ __Vdlyvset__SPI_Ctrl__DOT__wr_fifo__DOT__logic_ram__v0;
    CData/*0:0*/ __Vclklast__TOP__clk;
    CData/*0:0*/ __Vclklast__TOP__reset;
    SData/*15:0*/ __Vdlyvval__SPI_Ctrl__DOT__wr_fifo__DOT__logic_ram__v0;
  ...
  public:
    static void _combo__TOP__6(VSPI_Ctrl__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__4(VSPI_Ctrl__Syms* __restrict vlSymsp);
    static void _settle__TOP__5(VSPI_Ctrl__Syms* __restrict vlSymsp) VL_ATTR_COLD;
