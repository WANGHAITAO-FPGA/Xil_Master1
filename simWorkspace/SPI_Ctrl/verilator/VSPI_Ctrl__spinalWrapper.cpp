...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[4] = new CDataSignalAccess( top.config_kind_cpol );
      signalAccess[5] = new CDataSignalAccess( top.config_kind_cpha );
      signalAccess[6] = new CDataSignalAccess( top.config_sclkToogle );
      signalAccess[7] = new CDataSignalAccess( top.config_ss_activeHigh );
      signalAccess[8] = new CDataSignalAccess( top.config_ss_setup );
      signalAccess[9] = new CDataSignalAccess( top.config_ss_hold );
      signalAccess[10] = new CDataSignalAccess( top.config_ss_disable );
      signalAccess[11] = new CDataSignalAccess( top.cmd_valid );
      signalAccess[12] = new CDataSignalAccess( top.cmd_ready );
      signalAccess[13] = new SDataSignalAccess( top.cmd_payload );
      signalAccess[14] = new CDataSignalAccess( top.rsp_valid );
      signalAccess[15] = new CDataSignalAccess( top.rsp_ready );
      signalAccess[16] = new SDataSignalAccess( top.rsp_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\SPI_Ctrl/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\SPI_Ctrl/") + name + ".dat").c_str());
      #endif
    }
