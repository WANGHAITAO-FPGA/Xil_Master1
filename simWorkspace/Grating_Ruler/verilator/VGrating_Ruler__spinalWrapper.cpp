...
#endif
#include "VGrating_Ruler__Syms.h"
...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.config_valid );
      signalAccess[1] = new CDataSignalAccess( top.config_payload_mode );
      signalAccess[2] = new CDataSignalAccess( top.grating_io_IO_A_READ );
      signalAccess[3] = new CDataSignalAccess( top.grating_io_IO_B_READ );
      signalAccess[4] = new CDataSignalAccess( top.grating_io_IO_C_READ );
      signalAccess[5] = new CDataSignalAccess( top.grating_io_IO_A_WRITE );
      signalAccess[6] = new CDataSignalAccess( top.grating_io_IO_A_WRITEENABLE );
      signalAccess[7] = new CDataSignalAccess( top.grating_io_IO_B_WRITE );
      signalAccess[8] = new CDataSignalAccess( top.grating_io_IO_B_WRITEENABLE );
      signalAccess[9] = new CDataSignalAccess( top.grating_io_IO_C_WRITE );
      signalAccess[10] = new CDataSignalAccess( top.grating_io_IO_C_WRITEENABLE );
      signalAccess[11] = new CDataSignalAccess( top.bissc_clk );
      signalAccess[12] = new CDataSignalAccess( top.bissc_data );
      signalAccess[13] = new CDataSignalAccess( top.encoder_aphase );
      signalAccess[14] = new CDataSignalAccess( top.encoder_bphase );
      signalAccess[15] = new CDataSignalAccess( top.encoder_iphase );
      signalAccess[16] = new CDataSignalAccess( top.endat_clk );
      signalAccess[17] = new CDataSignalAccess( top.endat_write );
      signalAccess[18] = new CDataSignalAccess( top.endat_writeEnable );
      signalAccess[19] = new CDataSignalAccess( top.endat_read );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\Grating_Ruler/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("D:\\SCALA\\Xil_Master\\.\\simWorkspace\\Grating_Ruler/") + name + ".dat").c_str());
      #endif
    }
